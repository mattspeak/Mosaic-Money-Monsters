...
Gamification that only rewards progress keeps users engaged for a while — gamification that also builds knowledge and habit keeps them coming back. 

The difference is whether Money Monsters runs a learning loop or just a reward loop.
